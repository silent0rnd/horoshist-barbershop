...
export default function Footer() {
  return (
    <footer id="contacts" className="footer" aria-labelledby="contacts-title">
      ...
      <div className="site-author" style={{ padding: '17px 0 19px', borderTop: '1px solid rgba(24,21,19,.38)', color: '#3a1a0b', fontFamily: 'Manrope, sans-serif', fontSize: '8px', letterSpacing: '.09em' }}>Сайт разработан <a href="https://naklikay.ru/" target="_blank" rel="noopener" style={{ color: '#21130c', borderBottom: '1px solid rgba(33,19,12,.45)', textDecoration: 'none' }}>Максимом Мирошниковым</a></div>
    </footer>
  );
}
